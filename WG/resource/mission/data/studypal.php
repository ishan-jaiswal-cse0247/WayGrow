...
<body>
    ...
    <div class="fullp">
        <div class="img1">
            <img src="Image/studypal.png" class="imgg" alt="">
        </div>
        <div class="mdetail">
            <div class="about">
                <h3>About</h3>
                <p> Intern has to post and advertise about events
                    on their social media accounts and also have to
                    convence as many as possible candinates to join our event.</p>
            </div>
            <div class="exp">
                <h3>Experience<br></h3>
                <ul>
            ...
            <div class="skill">
                ...
                <ul>
                    ...
                    <li>Convencing skill</li>
                    <li>Must have Knowlwdge of Hashtags</li>
            ...
            <div>
            <a href ="../../studypal_apply.php"> <button type="button" class="btn btn-primary">Apply</button></a>            
        </div>
    </div>
