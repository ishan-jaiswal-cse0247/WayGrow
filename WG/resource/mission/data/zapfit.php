...
<body>
    ...
    <div class="fullp">
        <div class="img1">
            <img src="Image/zapfit.png" class="imgg" alt="">
        </div>
        <div class="mdetail">
            <div class="about">
                <h3>About</h3>
                <p>You have to design Pamplates or Banners for event and earn some extra money.
                </p>
            </div>
            <div class="exp">
                <h3>Experience<br></h3>
            ...
            <div class="skill">
                ...
                <ul>
                    ...
                    <li>Innovative</li>
                    <li>Must have Knowlwdge of Adobe Illistrator,
                        Adobe Photoshop
                        and etc.</li>
                </ul>
            </div>
            ...
            <div class="Duration">
                ...
                <ul>
                    <li>2 Days</li>
                    <li>Upto INR 200-500 </li>
                </ul>
            </div>
            <div>
            <a href ="../../zapfit_apply.php"> <button type="button" class="btn btn-primary">Apply</button></a>            </div>
        </div>
    </div>
    <!-- ============= Footer Started ============ -->
    <!-- <div class="main"> </div>
