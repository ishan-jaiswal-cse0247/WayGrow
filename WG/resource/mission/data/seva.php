...
<body>
    ...
    <div class="fullp">
        <div class="img1">
            <img src="Image/sewa.png" class="imgg" alt="">
        </div>
        <div class="mdetail">
            <div class="about">
                <h3>About</h3>
                <p>Student has to write for website, banners, pamplates, and etc. <br>
                    You must know good english and effective writing skills.
                </p>
            </div>
            <div class="exp">
                <h3>Experience<br></h3>
            ...
            <div class="skill">
                ...
                <ul>
                    <li>Skills for Song Writing and Singe</li>
                    <li>Good in Soft Skills</li>
                    <li>Effective Writing </li>
                    <li>Work as Team Leader</li>
                    <li>Must Know Hindi English </li>
                </ul>
            </div>
            ...
            <div>
            <a href ="../../seva_apply.php"> <button type="button" class="btn btn-primary">Apply</button></a>            </div>
        </div>
    </div>
    <!-- ============= Footer Started ============ -->
    <!-- <div class="main"> </div>
