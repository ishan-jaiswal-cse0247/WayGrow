...
<body>
    ...
    <div class="fullp">
        <div class="img1">
            <img src="Image/srimusic.png" class="imgg" alt="">
        </div>
        <div class="mdetail">
            <div class="about">
                <h3>About</h3>
                <p>Candinate has to Sing or Write a song in couple of weeks. and can also apply <br>
                    for both but time will remain same.
                </p>
            </div>
            <div class="exp">
                <h3>Experience<br></h3>
            ...
            <div class="skill">
                ...
                <ul>
                    <li>Skills for Song Writing and Singer</li>
                    <li>Good Soft Skills</li>
                    <li>Know how to write properly</li>
                    <li>Must Know Hindi
                        English </li>
                </ul>
            </div>
            ...
            <div>
            <a href ="../../srimusic_apply.php"> <button type="button" class="btn btn-primary">Apply</button></a>            </div>
        </div>
    </div>
    <!-- ============= Footer Started ============ -->
    <!-- <div class="main"> </div>
