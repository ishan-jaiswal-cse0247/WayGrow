...
<head>
    ...
    <link rel="stylesheet" href="internship.css?v=<?php echo time();?>">
...
<body>
    ...
    <div> 
    <h3><center>
    You are logged in as admin and hence you can add internships by filling the form given below, and when you select <br> any candinate from our 
...
Form to post your Internship.</h3>

<p><center>Note ;- This form must be filled correctly and properly because it may cause yours posting not be approved by WayGrow.</p>
<br>
   ...
   <pre>
    ...
    <?php 
        ...
        //if($_SESSION["token"] === "5e4df6edc4df35346f30e491d87c5701")
          ...
          $sql = "select * from postedintern where token ='$usrtoken'";
      ...
      echo'
                      ...
                      <div class="company-list">
                          <div class="row">
                           ...
                           <a href ="data/delintern.php?compname='.$compname.'">   <button type="button" class="btn btn-primary">Delete opportunity</button> </a>
